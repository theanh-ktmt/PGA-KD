...
EXP_NAME="PGA_FastVLM_full_grounding_r${LORA_R}_a${LORA_A}_bs${BATCH_SIZE}_mse${MSE_W}_pga${PGA_W}_scl${SCL_W}_var${VAR_T}"
USE_FULLSET=true
...
if [ "$USE_FULLSET" = true ]; then
    ...
    SUBSETS=("MSCOCO")
    echo "Running with SINGLE dataset (MSCOCO)."
fi
